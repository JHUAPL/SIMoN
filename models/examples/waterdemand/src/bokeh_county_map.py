...
def CountyMap(water_demand):
    ...
    for fips in water_demand:
        ...
        county_rates.append(water_demand[fips])
    ...
    tooltips=[
    ("Name", "@name"), ("State", "@state"), ("Water Demand", "@rate{int}"),("(Long, Lat)", "($x, $y)")
    ])
    ...
    return file_html(p, CDN, title="water demand")
